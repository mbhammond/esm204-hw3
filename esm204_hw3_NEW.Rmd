...
caption <- "Figure 2: Supply and demand curves for electricity for a high and low income population. The purple line represents the low income marginal benefit, the orange line represents the high income marginal benefit. The yellow line models demand aggregate. The blue line represents the MEC. The green line models the marginal private cost. The pink line represents the demand aggregate tax"
...
### Question 2: 
Aggregate monthly demand curve for electricity can be expressed as `P = 28.7-Q/2909`. Under status quo, consumer surplus is `r consumer_benefit_sq/100` dollars and producer surplus is `r producer_benefit_sq/100` dollars. The total environmental cost under status quo is `r total_environmental_cost/100` dollars.
...
### Question 3: 
The consumer benefit for high income consumers is `r consumer_benefit_sq_high/100` dollars while the consumer benefit for low income consumers is `r consumer_benefit_sq_low/100` dollars. High income consumers have a significantly higher benefit. 
