...
env_damage_fun <- function(x){336638.6 + 382446.5 * x} # NEED TO CHANGE THIS AFTER READING IN NEW CSV
...
tax_equal <- (664643 - 336638.6)/382446.5 # NEED TO CHANGE THIS AFTER READING IN NEW CSV
