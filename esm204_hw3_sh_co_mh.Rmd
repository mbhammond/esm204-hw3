...
Question 2 (cont.): Under status quo, consumer surplus is `r consumer_benefit_sq` cents and producer surplus is `r producer_benefit_sq` cents. The total environmental cost under status quo is `r total_environmental_cost` cents.
...
steps to solve: 
- read in data of total environmental costs versus tax (determined from SCC)
- plot total env costs vs tax
- calculate a regression model for the data
- use the regression equation to predict at what value of tax would the env costs equal 664643 cents *
